...
kind_6_headbutt_failure = {
    '0': '⚡CyberHerd⚡: Thank you for the repost, {name}! The herd is currently full. Reposts can only join when a slot is open. To join now, you must zap more than {required_sats} sats to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '1': '⚡CyberHerd⚡: We appreciate the signal boost, {name}, but the herd is at capacity. Joining via repost is only possible with open slots. To secure a spot, a zap greater than {required_sats} sats is needed to headbutt {victim_name}.\n\n https://lightning-goats.com\n\n',
    '10': '⚡CyberHerd⚡: Your attempt to join via repost was unsuccessful as the herd is full. To displace the lowest member, {victim_name}, a zap of {required_sats} sats is required.\n\n https://lightning-goats.com\n\n',
    '11': "⚡CyberHerd⚡: While we love the share, {name}, reposts can't headbutt. The herd is full. You can join by zapping more than {required_sats} sats to remove {victim_name}.\n\n https://lightning-goats.com\n\n",
    '12': "⚡CyberHerd⚡: The herd is currently at its 3-member limit, {name}. Reposting won't secure a spot, but a zap over {required_sats} sats will!\n\n https://lightning-goats.com\n\n",
    '13': '⚡CyberHerd⚡: Thank you for the amplification, {name}. Unfortunately, the herd is full. Entry is only possible by zapping to displace a member. Target: {victim_name} at {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '14': '⚡CyberHerd⚡: Access denied for repost entry, {name}. The herd is full. You can force your way in with a zap greater than {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '15': '⚡CyberHerd⚡: Your repost is valuable, but the herd is full, {name}. Zapping is now the only way in. A contribution over {required_sats} sats will displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '16': '⚡CyberHerd⚡: Repost entry is currently disabled as the herd is full. To join, {name}, you must out-zap the lowest member, {victim_name}, who has {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '17': '⚡CyberHerd⚡: The drawbridge is up for non-zap entries, {name}! The herd is at capacity. To storm the gates, send a zap of {required_sats}+ sats.\n\n https://lightning-goats.com\n\n',
    '18': "⚡CyberHerd⚡: We've registered your repost, {name}, but cannot grant entry. The herd is full. To take {victim_name}'s spot, a zap of {required_sats} sats is the key.\n\n https://lightning-goats.com\n\n",
    '19': "⚡CyberHerd⚡: Full house! Thanks for the repost, {name}, but there's no room. You can make room by zapping {required_sats} sats to replace {victim_name}.\n\n https://lightning-goats.com\n\n",
    '2': '⚡CyberHerd⚡: Entry via repost failed, {name}. The ⚡ CyberHerd ⚡ is full. While reposts are valued, they cannot displace members. A zap of at least {required_sats} sats will get you in by replacing {victim_name}.\n\n https://lightning-goats.com\n\n',
    '20': '⚡CyberHerd⚡: The herd is closed to free entries, {name}. Your repost is appreciated, but a zap is required to join now. Target amount: {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '21': "⚡CyberHerd⚡: Entry attempt by repost failed because the herd is full, {name}. To participate in payouts, you'll need to zap {required_sats}+ sats.\n\n https://lightning-goats.com\n\n",
    '22': '⚡CyberHerd⚡: Your signal boost is seen and appreciated, {name}. However, the herd is full. You can become a member by zapping over {required_sats} sats to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '23': "⚡CyberHerd⚡: All slots are currently filled by paying members, {name}. Reposts can't join until a slot is free. Or, you can create a slot by zapping {required_sats} sats.\n\n https://lightning-goats.com\n\n",
    '24': '⚡CyberHerd⚡: The gate is closed for repost entries, {name}, as we are at max capacity. A zap of {required_sats} sats is the secret knock to get in now.\n\n https://lightning-goats.com\n\n',
    '3': '⚡CyberHerd⚡: Thanks for sharing, {name}! Unfortunately, no spots are available in the herd. Repost entries are paused until a slot opens. You can join immediately by zapping over {required_sats} sats to headbutt {victim_name}.\n\n https://lightning-goats.com\n\n',
    '4': '⚡CyberHerd⚡: The herd is at maximum capacity, {name}. Your repost is appreciated but cannot grant entry at this time. To join the full herd, a contribution of {required_sats} sats or more is necessary to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '5': '⚡CyberHerd⚡: Your repost is appreciated, {name}, but the ⚡ CyberHerd ⚡ is at capacity. To gain entry, a zap exceeding {required_sats} sats is needed to unseat {victim_name}.\n\n https://lightning-goats.com\n\n',
    '6': "⚡CyberHerd⚡: Entry denied, {name}. The herd has no open slots for repost-based members. A zap of {required_sats}+ sats will secure {victim_name}'s spot for you.\n\n https://lightning-goats.com\n\n",
    '7': '⚡CyberHerd⚡: Thanks for spreading the word, {name}! The herd is currently closed to non-zap entries. You can bypass the queue by zapping more than {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '8': '⚡CyberHerd⚡: The ⚡ CyberHerd ⚡ is full, {name}. Your repost helps with visibility, but a zap is required to headbutt. The current minimum is {required_sats} sats to replace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '9': "⚡CyberHerd⚡: No vacancy, {name}. Repost entries are paused. To join the action now, zap at least {required_sats} sats and take {victim_name}'s place.\n\n https://lightning-goats.com\n\n",
}

kind_6_repost = {
    '0': '{name} has amplified our signal, joining the ⚡ CyberHerd ⚡. Thank you for sharing!\n\n https://lightning-goats.com\n\n',
    '1': "Welcome, {name}. By sharing our message, you've become part of the ⚡ CyberHerd ⚡. We appreciate the boost.\n\n https://lightning-goats.com\n\n",
    '10': '{name} has spread the message of the ⚡ CyberHerd ⚡. Welcome aboard, and thank you for sharing!\n\n https://lightning-goats.com\n\n',
    '11': 'The ⚡ CyberHerd ⚡ welcomes {name}. Your help in amplifying our voice is appreciated. Thank you!\n\n https://lightning-goats.com\n\n',
    '12': 'By sharing, {name} has joined our growing ⚡ CyberHerd ⚡. Thanks for being a key part of our network.\n\n https://lightning-goats.com\n\n',
    '13': "Welcome to the herd, {name}. Your repost has been registered with the ⚡ CyberHerd ⚡. We're grateful for the support.\n\n https://lightning-goats.com\n\n",
    '14': 'The ⚡ CyberHerd ⚡ is pleased to welcome {name} to our community of supporters. Thanks for the share!\n\n https://lightning-goats.com\n\n',
    '15': "{name}'s share is a boost for the whole herd. Welcome to the ⚡ CyberHerd ⚡. Thank you for the repost.\n\n https://lightning-goats.com\n\n",
    '16': 'A new signal booster has joined the ⚡ CyberHerd ⚡: {name}. Thank you for helping us reach more people.\n\n https://lightning-goats.com\n\n',
    '17': 'Welcome, {name}. The ⚡ CyberHerd ⚡ thrives on amplifiers like you. We appreciate the boost!\n\n https://lightning-goats.com\n\n',
    '18': '{name} is now a recognized amplifier for the ⚡ CyberHerd ⚡. Our heartfelt thanks for sharing.\n\n https://lightning-goats.com\n\n',
    '19': "The ⚡ CyberHerd ⚡ acknowledges {name}'s contribution. Welcome to our network, and thanks for the repost.\n\n https://lightning-goats.com\n\n",
    '2': '{name} is now a member of the ⚡ CyberHerd ⚡ for boosting our reach. Thanks for spreading the word!\n\n https://lightning-goats.com\n\n',
    '20': 'Your reach is valuable, {name}. Welcome to the ⚡ CyberHerd ⚡. Thank you for lending your voice.\n\n https://lightning-goats.com\n\n',
    '21': 'Greetings, {name}. Your repost has earned you a spot in the ⚡ CyberHerd ⚡. Thank you for spreading the word.\n\n https://lightning-goats.com\n\n',
    '22': '{name}, your help in sharing our mission is clear. Welcome to the ⚡ CyberHerd ⚡, and thanks a million!\n\n https://lightning-goats.com\n\n',
    '23': "The ⚡ CyberHerd ⚡ expands with {name}'s repost. Welcome! We appreciate you sharing our content.\n\n https://lightning-goats.com\n\n",
    '24': 'A warm welcome from the herd to {name}. You are now part of the ⚡ CyberHerd ⚡. Thank you for the boost!\n\n https://lightning-goats.com\n\n',
    '3': 'A warm welcome to {name} for reposting and joining the ⚡ CyberHerd ⚡. Your help is much appreciated.\n\n https://lightning-goats.com\n\n',
    '4': "{name}'s share has been noted. Welcome to the ⚡ CyberHerd ⚡ mission. Thank you for the signal boost.\n\n https://lightning-goats.com\n\n",
    '5': 'The herd sees your signal boost, {name}. Welcome to the ⚡ CyberHerd ⚡. Thank you for amplifying our message.\n\n https://lightning-goats.com\n\n',
    '6': '{name} has been welcomed into the ⚡ CyberHerd ⚡ for spreading the word. We are grateful for your help.\n\n https://lightning-goats.com\n\n',
    '7': 'Welcome, {name}, to the ⚡ CyberHerd ⚡. Every repost helps us grow, so thank you for your support!\n\n https://lightning-goats.com\n\n',
    '8': 'The ⚡ CyberHerd ⚡ has a new amplifier: {name}. Thank you for getting the message out.\n\n https://lightning-goats.com\n\n',
    '9': '{name}, you are now officially part of the ⚡ CyberHerd ⚡ for helping share our content. We truly appreciate it.\n\n https://lightning-goats.com\n\n',
}

kind_7_headbutt_failure = {
    '0': '⚡CyberHerd⚡: Thank you for the positive reaction, {name}! The herd is currently full. Reactions can only join when a slot is open. To join now, you must zap more than {required_sats} sats to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '1': '⚡CyberHerd⚡: We appreciate the support, {name}, but the herd is at capacity. Joining via reaction is only possible with open slots. To secure a spot, a zap greater than {required_sats} sats is needed to headbutt {victim_name}.\n\n https://lightning-goats.com\n\n',
    '10': '⚡CyberHerd⚡: Your attempt to join via reaction was unsuccessful as the herd is full. To displace the lowest member, {victim_name}, a zap of {required_sats} sats is required.\n\n https://lightning-goats.com\n\n',
    '11': "⚡CyberHerd⚡: While we love the support, {name}, reactions can't headbutt. The herd is full. You can join by zapping more than {required_sats} sats to remove {victim_name}.\n\n https://lightning-goats.com\n\n",
    '12': "⚡CyberHerd⚡: The herd is currently at its 3-member limit, {name}. Reacting won't secure a spot, but a zap over {required_sats} sats will!\n\n https://lightning-goats.com\n\n",
    '13': '⚡CyberHerd⚡: Thank you for the engagement, {name}. Unfortunately, the herd is full. Entry is only possible by zapping to displace a member. Target: {victim_name} at {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '14': '⚡CyberHerd⚡: Access denied for reaction entry, {name}. The herd is full. You can force your way in with a zap greater than {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '15': '⚡CyberHerd⚡: Your reaction is valuable, but the herd is full, {name}. Zapping is now the only way in. A contribution over {required_sats} sats will displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '16': '⚡CyberHerd⚡: Reaction entry is currently disabled as the herd is full. To join, {name}, you must out-zap the lowest member, {victim_name}, who has {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '17': '⚡CyberHerd⚡: The drawbridge is up for non-zap entries, {name}! The herd is at capacity. To storm the gates, send a zap of {required_sats}+ sats.\n\n https://lightning-goats.com\n\n',
    '18': "⚡CyberHerd⚡: We've registered your reaction, {name}, but cannot grant entry. The herd is full. To take {victim_name}'s spot, a zap of {required_sats} sats is the key.\n\n https://lightning-goats.com\n\n",
    '19': "⚡CyberHerd⚡: Full house! Thanks for the positive reaction, {name}, but there's no room. You can make room by zapping {required_sats} sats to replace {victim_name}.\n\n https://lightning-goats.com\n\n",
    '2': '⚡CyberHerd⚡: Entry via reaction failed, {name}. The ⚡ CyberHerd ⚡ is full. While reactions are valued, they cannot displace members. A zap of at least {required_sats} sats will get you in by replacing {victim_name}.\n\n https://lightning-goats.com\n\n',
    '20': '⚡CyberHerd⚡: The herd is closed to free entries, {name}. Your reaction is appreciated, but a zap is required to join now. Target amount: {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '21': "⚡CyberHerd⚡: Entry attempt by reaction failed because the herd is full, {name}. To participate in payouts, you'll need to zap {required_sats}+ sats.\n\n https://lightning-goats.com\n\n",
    '22': '⚡CyberHerd⚡: Your support is seen and appreciated, {name}. However, the herd is full. You can become a member by zapping over {required_sats} sats to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '23': "⚡CyberHerd⚡: All slots are currently filled by paying members, {name}. Reactions can't join until a slot is free. Or, you can create a slot by zapping {required_sats} sats.\n\n https://lightning-goats.com\n\n",
    '24': '⚡CyberHerd⚡: The gate is closed for reaction entries, {name}, as we are at max capacity. A zap of {required_sats} sats is the secret knock to get in now.\n\n https://lightning-goats.com\n\n',
    '3': '⚡CyberHerd⚡: Thanks for the support, {name}! Unfortunately, no spots are available in the herd. Reaction entries are paused until a slot opens. You can join immediately by zapping over {required_sats} sats to headbutt {victim_name}.\n\n https://lightning-goats.com\n\n',
    '4': '⚡CyberHerd⚡: The herd is at maximum capacity, {name}. Your reaction is appreciated but cannot grant entry at this time. To join the full herd, a contribution of {required_sats} sats or more is necessary to displace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '5': '⚡CyberHerd⚡: Your reaction is appreciated, {name}, but the ⚡ CyberHerd ⚡ is at capacity. To gain entry, a zap exceeding {required_sats} sats is needed to unseat {victim_name}.\n\n https://lightning-goats.com\n\n',
    '6': "⚡CyberHerd⚡: Entry denied, {name}. The herd has no open slots for reaction-based members. A zap of {required_sats}+ sats will secure {victim_name}'s spot for you.\n\n https://lightning-goats.com\n\n",
    '7': '⚡CyberHerd⚡: Thanks for the positive feedback, {name}! The herd is currently closed to non-zap entries. You can bypass the queue by zapping more than {required_sats} sats.\n\n https://lightning-goats.com\n\n',
    '8': '⚡CyberHerd⚡: The ⚡ CyberHerd ⚡ is full, {name}. Your reaction shows support, but a zap is required to headbutt. The current minimum is {required_sats} sats to replace {victim_name}.\n\n https://lightning-goats.com\n\n',
    '9': "⚡CyberHerd⚡: No vacancy, {name}. Reaction entries are paused. To join the action now, zap at least {required_sats} sats and take {victim_name}'s place.\n\n https://lightning-goats.com\n\n",
}

kind_7_reaction = {
    '0': '{name} has joined the ⚡ CyberHerd ⚡ with a positive reaction. Thank you for the support!\n\n https://lightning-goats.com\n\n',
    '1': 'Welcome, {name}. Your support strengthens the ⚡ CyberHerd ⚡. We appreciate the positive reaction.\n\n https://lightning-goats.com\n\n',
    '10': '{name} has signaled their support for the ⚡ CyberHerd ⚡. Welcome, and many thanks!\n\n https://lightning-goats.com\n\n',
    '11': 'The ⚡ CyberHerd ⚡ welcomes {name}. Your positive feedback is appreciated. Thank you!\n\n https://lightning-goats.com\n\n',
    '12': 'By reacting, {name} has joined our growing ⚡ CyberHerd ⚡. Thanks for being part of our community.\n\n https://lightning-goats.com\n\n',
    '13': "Welcome to the herd, {name}. Your support has been registered in the ⚡ CyberHerd ⚡. We're very grateful.\n\n https://lightning-goats.com\n\n",
    '14': 'The ⚡ CyberHerd ⚡ is pleased to welcome {name}. Thank you for taking the time to react.\n\n https://lightning-goats.com\n\n',
    '15': "{name}'s positive reaction is a boost for us all. Welcome to the ⚡ CyberHerd ⚡, and thank you.\n\n https://lightning-goats.com\n\n",
    '16': 'A new ally has joined the ⚡ CyberHerd ⚡: {name}. Thank you for showing your support.\n\n https://lightning-goats.com\n\n',
    '17': 'Welcome, {name}. The ⚡ CyberHerd ⚡ thrives on supporters like you. We appreciate you!\n\n https://lightning-goats.com\n\n',
    '18': '{name} is now a recognized supporter of the ⚡ CyberHerd ⚡. Our heartfelt thanks.\n\n https://lightning-goats.com\n\n',
    '19': "The ⚡ CyberHerd ⚡ acknowledges {name}'s support. Welcome to our community, and thank you.\n\n https://lightning-goats.com\n\n",
    '2': '{name} is now a member of the ⚡ CyberHerd ⚡. Your positive feedback is valued, thank you.\n\n https://lightning-goats.com\n\n',
    '20': 'Your engagement is valuable, {name}. Welcome to the ⚡ CyberHerd ⚡. Thanks for your contribution.\n\n https://lightning-goats.com\n\n',
    '21': 'Greetings, {name}. Your reaction has granted you a place in the ⚡ CyberHerd ⚡. Thank you for joining in.\n\n https://lightning-goats.com\n\n',
    '22': '{name}, your support for the herd is clear. Welcome to the ⚡ CyberHerd ⚡, and thanks a lot!\n\n https://lightning-goats.com\n\n',
    '23': "The ⚡ CyberHerd ⚡ expands with {name}'s support. Welcome! We appreciate the positive feedback.\n\n https://lightning-goats.com\n\n",
    '24': 'A warm welcome from the herd to {name}. You are now part of the ⚡ CyberHerd ⚡. Thank you for your support.\n\n https://lightning-goats.com\n\n',
    '3': "A warm welcome to {name} for supporting the ⚡ CyberHerd ⚡. We're grateful for your reaction.\n\n https://lightning-goats.com\n\n",
    '4': "{name}'s reaction has been noted. Welcome to the ⚡ CyberHerd ⚡. Thanks for the engagement!\n\n https://lightning-goats.com\n\n",
    '5': 'The herd sees your support, {name}. Welcome to the ⚡ CyberHerd ⚡. Thank you for the encouragement.\n\n https://lightning-goats.com\n\n',
    '6': '{name} has been welcomed into the ⚡ CyberHerd ⚡. Your engagement matters, and we thank you for it.\n\n https://lightning-goats.com\n\n',
    '7': 'Welcome, {name}, to the ⚡ CyberHerd ⚡. Every reaction helps us grow, so thank you!\n\n https://lightning-goats.com\n\n',
    '8': 'The ⚡ CyberHerd ⚡ has a new supporter: {name}. Thank you for the positive signal.\n\n https://lightning-goats.com\n\n',
    '9': '{name}, you are now officially part of the ⚡ CyberHerd ⚡ community. We appreciate your support.\n\n https://lightning-goats.com\n\n',
}
...
zapper_displaces_kind_6 = {
    '0': '⚡headbutt⚡: Zapper priority! {attacker_name} ({attacker_amount} sats) has joined the ⚡ CyberHerd ⚡, displacing {victim_name} who joined via repost.\n\n https://lightning-goats.com\n\n',
    '1': '⚡headbutt⚡: The herd welcomes a new zapper! {attacker_name} ({attacker_amount} sats) takes the spot from repost-member {victim_name}.\n\n https://lightning-goats.com\n\n',
    '10': '⚡headbutt⚡: Repost slot filled by a zap! Welcome {attacker_name} ({attacker_amount} sats). {victim_name} has been displaced from the herd.\n\n https://lightning-goats.com\n\n',
    '11': '⚡headbutt⚡: A paid entry takes priority. {attacker_name} ({attacker_amount} sats) has headbutted the repost-only member, {victim_name}.\n\n https://lightning-goats.com\n\n',
    '12': "⚡headbutt⚡: The herd's composition has changed. {attacker_name}'s {attacker_amount} sat zap displaces the repost entry from {victim_name}.\n\n https://lightning-goats.com\n\n",
    '13': "⚡headbutt⚡: Welcome zapper {attacker_name}! With a {attacker_amount} sat contribution, you've replaced {victim_name}'s repost-based membership.\n\n https://lightning-goats.com\n\n",
    '14': '⚡headbutt⚡: The rules are clear: zaps first! {attacker_name} ({attacker_amount} sats) has taken the spot from {victim_name} (repost member).\n\n https://lightning-goats.com\n\n',
    '15': '⚡headbutt⚡: A new financial contributor joins! {attacker_name} ({attacker_amount} sats) replaces {victim_name}, who had joined by reposting.\n\n https://lightning-goats.com\n\n',
    '16': '⚡headbutt⚡: Repost-based membership is vulnerable! {attacker_name} ({attacker_amount} sats) has successfully claimed the spot from {victim_name}.\n\n https://lightning-goats.com\n\n',
    '17': '⚡headbutt⚡: The ⚡ CyberHerd ⚡ is now stronger with a new zap. {attacker_name} ({attacker_amount} sats) displaces {victim_name} (repost entry).\n\n https://lightning-goats.com\n\n',
    '18': "⚡headbutt⚡: Official change: {victim_name}'s repost slot has been claimed by {attacker_name} with a {attacker_amount} sat zap.\n\n https://lightning-goats.com\n\n",
    '19': '⚡headbutt⚡: A zap always wins! {attacker_name} ({attacker_amount} sats) is in, and {victim_name} (repost member) is out.\n\n https://lightning-goats.com\n\n',
    '2': '⚡headbutt⚡: Membership update! {attacker_name} has entered with a {attacker_amount} sat zap, replacing {victim_name} (entry via repost).\n\n https://lightning-goats.com\n\n',
    '20': '⚡headbutt⚡: The herd has been upgraded! {attacker_name} ({attacker_amount} sats) takes the place of {victim_name}, our former repost-based member.\n\n https://lightning-goats.com\n\n',
    '21': '⚡headbutt⚡: Welcome to the herd, {attacker_name}! Your {attacker_amount} sat zap has successfully displaced the repost entry of {victim_name}.\n\n https://lightning-goats.com\n\n',
    '22': '⚡headbutt⚡: Zapper entry successful! {attacker_name} ({attacker_amount} sats) now holds a spot, removing {victim_name} who joined via repost.\n\n https://lightning-goats.com\n\n',
    '23': "⚡headbutt⚡: The balance of the herd shifts. {attacker_name} ({attacker_amount} sats) enters, and {victim_name}'s repost membership is concluded.\n\n https://lightning-goats.com\n\n",
    '24': '⚡headbutt⚡: A zap contribution has been prioritized. {attacker_name} ({attacker_amount} sats) has replaced {victim_name} in the herd.\n\n https://lightning-goats.com\n\n',
    '3': '⚡headbutt⚡: A zap takes precedence! {attacker_name} ({attacker_amount} sats) has successfully displaced {victim_name}, who was a repost-only member.\n\n https://lightning-goats.com\n\n',
    '4': '⚡headbutt⚡: Roster change! {attacker_name} is now in the ⚡ CyberHerd ⚡ with {attacker_amount} sats, taking the place of {victim_name} (repost entry).\n\n https://lightning-goats.com\n\n',
    '5': '⚡headbutt⚡: A zap has upgraded the herd! {attacker_name} ({attacker_amount} sats) now occupies the slot previously held by {victim_name} (repost member).\n\n https://lightning-goats.com\n\n',
    '6': '⚡headbutt⚡: Roster change confirmed! The repost entry of {victim_name} has been replaced by zapper {attacker_name} with {attacker_amount} sats.\n\n https://lightning-goats.com\n\n',
    '7': '⚡headbutt⚡: Zaps have priority. {attacker_name} ({attacker_amount} sats) has secured a position, displacing {victim_name} from their repost-based spot.\n\n https://lightning-goats.com\n\n',
    '8': '⚡headbutt⚡: The ⚡ CyberHerd ⚡ has a new zapper! {attacker_name} enters with {attacker_amount} sats, and {victim_name} (repost entry) has been removed.\n\n https://lightning-goats.com\n\n',
    '9': '⚡headbutt⚡: Entry secured by zap! {attacker_name} ({attacker_amount} sats) is now a member, taking over from {victim_name}, who joined via repost.\n\n https://lightning-goats.com\n\n',
}

zapper_displaces_kind_7 = {
    '0': '⚡headbutt⚡: Zapper priority! {attacker_name} ({attacker_amount} sats) has joined the ⚡ CyberHerd ⚡, displacing {victim_name} who joined via reaction.\n\n https://lightning-goats.com\n\n',
    '1': '⚡headbutt⚡: The herd welcomes a new zapper! {attacker_name} ({attacker_amount} sats) takes the spot from reaction-member {victim_name}.\n\n https://lightning-goats.com\n\n',
    '10': '⚡headbutt⚡: Reaction slot filled by a zap! Welcome {attacker_name} ({attacker_amount} sats). {victim_name} has been displaced from the herd.\n\n https://lightning-goats.com\n\n',
    '11': '⚡headbutt⚡: A paid entry takes priority. {attacker_name} ({attacker_amount} sats) has headbutted the reaction-only member, {victim_name}.\n\n https://lightning-goats.com\n\n',
    '12': "⚡headbutt⚡: The herd's composition has changed. {attacker_name}'s {attacker_amount} sat zap displaces the reaction entry from {victim_name}.\n\n https://lightning-goats.com\n\n",
    '13': "⚡headbutt⚡: Welcome zapper {attacker_name}! With a {attacker_amount} sat contribution, you've replaced {victim_name}'s reaction-based membership.\n\n https://lightning-goats.com\n\n",
    '14': '⚡headbutt⚡: The rules are clear: zaps first! {attacker_name} ({attacker_amount} sats) has taken the spot from {victim_name} (reaction member).\n\n https://lightning-goats.com\n\n',
    '15': '⚡headbutt⚡: A new financial contributor joins! {attacker_name} ({attacker_amount} sats) replaces {victim_name}, who had joined by reacting.\n\n https://lightning-goats.com\n\n',
    '16': '⚡headbutt⚡: Reaction-based membership is vulnerable! {attacker_name} ({attacker_amount} sats) has successfully claimed the spot from {victim_name}.\n\n https://lightning-goats.com\n\n',
    '17': '⚡headbutt⚡: The ⚡ CyberHerd ⚡ is now stronger with a new zap. {attacker_name} ({attacker_amount} sats) displaces {victim_name} (reaction entry).\n\n https://lightning-goats.com\n\n',
    '18': "⚡headbutt⚡: Official change: {victim_name}'s reaction slot has been claimed by {attacker_name} with a {attacker_amount} sat zap.\n\n https://lightning-goats.com\n\n",
    '19': '⚡headbutt⚡: A zap always wins! {attacker_name} ({attacker_amount} sats) is in, and {victim_name} (reaction member) is out.\n\n https://lightning-goats.com\n\n',
    '2': '⚡headbutt⚡: Membership update! {attacker_name} has entered with a {attacker_amount} sat zap, replacing {victim_name} (entry via reaction).\n\n https://lightning-goats.com\n\n',
    '20': '⚡headbutt⚡: The herd has been upgraded! {attacker_name} ({attacker_amount} sats) takes the place of {victim_name}, our former reaction-based member.\n\n https://lightning-goats.com\n\n',
    '21': '⚡headbutt⚡: Welcome to the herd, {attacker_name}! Your {attacker_amount} sat zap has successfully displaced the reaction entry of {victim_name}.\n\n https://lightning-goats.com\n\n',
    '22': '⚡headbutt⚡: Zapper entry successful! {attacker_name} ({attacker_amount} sats) now holds a spot, removing {victim_name} who joined via reaction.\n\n https://lightning-goats.com\n\n',
    '23': "⚡headbutt⚡: The balance of the herd shifts. {attacker_name} ({attacker_amount} sats) enters, and {victim_name}'s reaction membership is concluded.\n\n https://lightning-goats.com\n\n",
    '24': '⚡headbutt⚡: A zap contribution has been prioritized. {attacker_name} ({attacker_amount} sats) has replaced {victim_name} in the herd.\n\n https://lightning-goats.com\n\n',
    '3': '⚡headbutt⚡: A zap takes precedence! {attacker_name} ({attacker_amount} sats) has successfully displaced {victim_name}, who was a reaction-only member.\n\n https://lightning-goats.com\n\n',
    '4': '⚡headbutt⚡: Roster change! {attacker_name} is now in the ⚡ CyberHerd ⚡ with {attacker_amount} sats, taking the place of {victim_name} (reaction entry).\n\n https://lightning-goats.com\n\n',
    '5': '⚡headbutt⚡: A zap has upgraded the herd! {attacker_name} ({attacker_amount} sats) now occupies the slot previously held by {victim_name} (reaction member).\n\n https://lightning-goats.com\n\n',
    '6': '⚡headbutt⚡: Roster change confirmed! The reaction entry of {victim_name} has been replaced by zapper {attacker_name} with {attacker_amount} sats.\n\n https://lightning-goats.com\n\n',
    '7': '⚡headbutt⚡: Zaps have priority. {attacker_name} ({attacker_amount} sats) has secured a position, displacing {victim_name} from their reaction-based spot.\n\n https://lightning-goats.com\n\n',
    '8': '⚡headbutt⚡: The ⚡ CyberHerd ⚡ has a new zapper! {attacker_name} enters with {attacker_amount} sats, and {victim_name} (reaction entry) has been removed.\n\n https://lightning-goats.com\n\n',
    '9': '⚡headbutt⚡: Entry secured by zap! {attacker_name} ({attacker_amount} sats) is now a member, taking over from {victim_name}, who joined via reaction.\n\n https://lightning-goats.com\n\n',
}
