...
- Zap a #CyberHerd tagged note with at least 10 sats

**Note**: Only zaps to Lightning Goats project notes are processed for CyberHerd membership.
...
- **Must zap #CyberHerd notes**: New members can only join by zapping notes tagged with #CyberHerd
- **Structured onboarding**: This ensures proper introduction to the CyberHerd system
...
- You zap: 250 sats to a #CyberHerd note → You replace the 200-sat member
...
- You zap: 150 sats to a #CyberHerd note → Headbutt fails (need 201+ sats to exceed 200)
...
- Someone headbutts you out with 450 sats to a #CyberHerd note → You lose your spot AND your previous zap amount is reset to zero
- To rejoin: You must start fresh with a new zap to a #CyberHerd note that exceeds the current lowest member
...
### Headbutting Rules:
- **New members only**: Only new members can attempt headbutting by zapping #CyberHerd notes
...
- **Fresh start**: To rejoin after being headbutted, you start with zero sats and must zap a #CyberHerd note again
...
2. **Find CyberHerd note**: Look for Today's #CyberHerd tagged note(s) by the Lightning Goats project
3. **Zap to join**: Send a zap of 10+ sats to join the herd
4. **Handle full herd**: If the herd is full (3 members), you can still join by headbutting out the lowest member - just zap more than their total contribution
...
- **New members**: Must zap #CyberHerd tagged notes to join (10+ sats minimum)
