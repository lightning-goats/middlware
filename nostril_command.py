...
async def run_nostril_command(nos_sec: str, new_amount: float, difference: float, event_type: str):
    ...
    2: "The goats got treats right now! Join the fun at Watch live and get up to date progress at:  https://lightning-goats.com. {goat_name} is getting his fill!",
    ...
    5: "Thanks to your contributions, {goat_name} and the rest of the herd are enjoying a feast! Join us at Watch live and get up to date progress at:  https://lightning-goats.com",
    6: "Food has arrived for the herd! Watch {goat_name} and the others enjoy their treats at Watch live and get up to date progress at:  https://lightning-goats.com",
    7: "Happy goats over here! {goat_name} is particularly pleased with this round of feeding. Join us at Watch live and get up to date progress at:  https://lightning-goats.com",
    ...
    10: "The herd is gathering for a meal, all thanks to you! {goat_name} is leading the charge. Join the fun at Watch live and get up to date progress at:  https://lightning-goats.com",
    ...
    16: "Feeding time is here! {goat_name} is enjoying the meal you've made possible. Join us at Watch live and get up to date progress at:  https://lightning-goats.com",
    ...
    19: "Thanks to your help, it's feeding time at the farm! {goat_name} couldn't be happier. Join us at Watch live and get up to date progress at:  https://lightning-goats.com",
